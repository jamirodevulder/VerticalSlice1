...
public class MenuButton : UIScript
{
    private void Awake()
    {
        ...
        clickableButton.transform.position = new Vector3(mainCamera.transform.position.x - 9.2f, mainCamera.transform.position.y - 2, mainCamera.transform.position.z + 10);
    }
